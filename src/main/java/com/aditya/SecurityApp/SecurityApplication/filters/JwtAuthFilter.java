package com.aditya.SecurityApp.SecurityApplication.filters;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    @Autowired // constructor injecction is not working so added this
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (userId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                // below is imp for ipadress and device information , for ratelimiting, ddos attack etc
